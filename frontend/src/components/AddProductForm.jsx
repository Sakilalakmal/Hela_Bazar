...
export default function AddProductForm() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-8 bg-white">
      {/* Header Section */}
      <div className="mb-10">
        <h1 className="text-3xl font-bold text-gray-900 mb-3">Add New Product</h1>
        <p className="text-gray-600 text-lg">Create a new product listing for your store</p>
      ...
      <form className="space-y-10" onSubmit={handleSubmit} encType="multipart/form-data">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8">
          ...
          {images.length > 0 && (
            <div className="mt-6">
              <h4 className="text-sm font-semibold text-gray-700 mb-4">Image Preview ({images.length} selected)</h4>
