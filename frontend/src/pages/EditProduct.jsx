...
import { getProductById , updateProduct } from "../services/updateProductDetailsService";
import { useAuth } from "../context/AuthContext";

// Helper for variants/customizations
const blankVariant = { optionName: "", optionValues: "" };
const blankCustomization = { type: "", values: "", priceType: "fixed", priceValue: "" };
...
export default function EditProduct() {
  ...
  useEffect(() => {
    ...
    getProductById(productId, token)
      .then((data) => {
        ...
        // Set customizations
        setCustomizations(product.customizationOptions && product.customizationOptions.length > 0
  ...
  const removeCurrentImage = (idx) => setCurrentImages(currentImages.filter((_, i) => i !== idx));
    ...
    <div className="max-w-5xl mx-auto p-8 bg-white">
      ...
      <div className="mb-10">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-3">Edit Product</h1>
      ...
      <form className="space-y-10" onSubmit={handleSubmit} encType="multipart/form-data">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8">
          <div className="flex items-center mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">Set your pricing and stock information</p>
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-3">Price (LKR) *</label>
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-3">SEO Slug</label>
              <input 
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                name="slug" 
                value={form.slug} 
        ...
        {currentImages.length > 0 && (
          <div className="bg-white border border-gray-200 rounded-xl p-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900">Current Images</h2>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8">
          <div className="flex items-center mb-6">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900">Upload New Images</h2>
              <p className="text-gray-600 text-sm">Add new images or replace existing ones</p>
            </div>
          </div>
          ...
          {images.length > 0 && (
            <div className="mt-6">
              <h4 className="text-sm font-semibold text-gray-700 mb-4">New Images Preview ({images.length} selected)</h4>
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                {images.map((img, idx) => (
                  <div key={idx} className="relative group">
                    <img 
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Add size, color, or other product options</p>
              </div>
            </div>
            <button 
              type="button" 
          ...
          {variants.length === 0 ? (
            <div className="text-center py-8 text-gray-500">
              <p>No variants added yet. Click "Add Variant" to create product options.</p>
            </div>
          ) : (
              ...
              {variants.map((v, idx) => (
                <div key={idx} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="font-semibold text-gray-900">Variant {idx + 1}</h4>
                    <button 
                      type="button" 
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Add engraving, personalization, or custom features</p>
              </div>
            </div>
            <button 
              type="button" 
          ...
          {customizations.length === 0 ? (
            <div className="text-center py-8 text-gray-500">
              <p>No customization options added yet. Click "Add Customization" to create custom features.</p>
            </div>
          ) : (
            <div className="space-y-4">
              {customizations.map((c, idx) => (
                <div key={idx} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="font-semibold text-gray-900">Customization {idx + 1}</h4>
                    <button 
                      type="button" 
                      className="text-red-600 hover:text-red-800 text-sm font-medium"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select 
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors bg-white"
                        value={c.priceType}
                        onChange={e => handleCustomizationChange(idx, "priceType", e.target.value)}
                      >
                    ...
                    <div>
                      ...
                      <input 
                        ...
                        value={c.priceValue}
                        onChange={e => handleCustomizationChange(idx, "priceValue", e.target.value)} 
                      />
                    </div>
                  </div>
                </div>
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-8">
          <div className="flex items-center mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">Control product visibility and features</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <label className="flex items-center p-4 bg-white border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                ...
                />
                <div>
                  <span className="font-semibold text-gray-900">Active Product</span>
