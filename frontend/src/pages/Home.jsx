...
function Home() {
  return (
    <div className="w-full m-0 p-0">
      {/* Hero Section with Video - Full Edge to Edge */}
      ...
      {/* About Sri Lanka Section - Full Width */}
      <section className="w-full py-20 bg-gradient-to-br from-green-50 to-blue-50 m-0">
        <div className="px-4 sm:px-6 lg:px-8">
      ...
      <section className="w-full py-20 bg-white m-0">
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
      ...
      <section className="w-full py-20 bg-gradient-to-r from-blue-600 to-purple-700 m-0">
        <div className="px-4 sm:px-6 lg:px-8">
